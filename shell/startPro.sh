source /etc/profile
NAME=demo.jar
CONFIG_LOCATION=./config/application-pro.properties
#JAVA_OPT="-Xms1024m -Xmx1024m -XX:PermSize=256M -XX:MaxPermSize=512m" 
JAVA_OPTS="$JAVA_OPTS -Xms2048m -Xmx2048m -XX:MaxNewSize=256m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=256m -Djava.awt.headless=true -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager"
